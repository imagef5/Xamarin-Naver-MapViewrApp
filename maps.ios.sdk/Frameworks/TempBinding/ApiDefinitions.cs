...
namespace NMapViewerSDK
{
	...
	interface NMapView_NMapController
	{
		...
		// @property (nonatomic) int boundsVisible;
		...
		void SetMapVersionVector (NSObject[] vectorVer, NSObject[] satelliteVer, NSObject[] overlayVer, NSObject[] trafficVer, NSObject[] panoramaVer, NSObject[] bicycleVer);
		...
		[Verify (StronglyTypedNSArray), Verify (StronglyTypedNSArray), Verify (StronglyTypedNSArray), Verify (StronglyTypedNSArray), Verify (StronglyTypedNSArray), Verify (StronglyTypedNSArray)]
		void ChangeMapVersionVector (NSObject[] vectorVer, NSObject[] satelliteVer, NSObject[] overlayVer, NSObject[] trafficVer, NSObject[] panoramaVer, NSObject[] bicycleVer);
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] RetrieveTilesKeyListForOfflineMapWithRadius (float radius, int minLevel, int maxLevel, NGeoPoint center);
		...
		[Verify (StronglyTypedNSArray)]
		NSObject[] RetrieveTilesKeyListForOfflineMapWithRadius (float radius, int minLevel, int maxLevel, int utmkX, int utmkY);
	...
	interface NMapLocationManager : ICLLocationManagerDelegate
	{
		...
		[Export ("setDelegate:")]
		void SetDelegate (NMapLocationManagerDelegate @delegate);
	...
	[BaseType (typeof(NSObject))]
	interface NMapOverlay : INMapOverlayDelegate
	{
	...
	interface NMapPOIdataOverlay
	{
		...
		[Wrap ("WeakDelegate")]
		NMapPOIdataOverlayDelegate Delegate { get; set; }
		...
		NMapPOIitem AddPOIitemAtLocation (NGeoPoint location, string title, int poiFlagType, NSObject @object);
		...
		NMapPOIitem AddPOIitemAtLocation (NGeoPoint location, string title, int poiFlagType, int iconIndex, NSObject @object);
		...
		NMapPOIitem AddPOIitemAtLocationInUtmk (NPoint utmk, string title, int poiFlagType, NSObject @object);
		...
		NMapPOIitem AddPOIitemAtLocationInUtmk (NPoint utmk, string title, int poiFlagType, int iconIndex, NSObject @object);
	...
	interface NMapPOIdataOverlayDelegate
	{
		...
		UIImage OnMapOverlay (NMapPOIdataOverlay poiDataOverlay, int index, bool selected, NSObject @object);
	...
	interface NMapOverlayManager
	{
		...
		[Verify (StronglyTypedNSArray)]
		NMapPathDataOverlay NewPathDataArrayOverlay (NSObject[] pathDataArray);
		...
		[Verify (StronglyTypedNSArray)]
		NMapPathDataOverlay NewPathDataArrayOverlay (NSObject[] pathDataArray, NMapOverlayZPosition zPosition);

		// -(NMapPathDataOverlay *)addPathDataArrayOverlay:(NSArray *)pathDataArray;
		[Export ("addPathDataArrayOverlay:")]
		[Verify (StronglyTypedNSArray)]
		NMapPathDataOverlay AddPathDataArrayOverlay (NSObject[] pathDataArray);
	...
	interface NMapView : ICAAnimationDelegate
	{
		[Wrap ("WeakDelegate")]
		NSObject<NMapViewDelegate, NMapPOIdataOverlayDelegate> Delegate { get; set; }
		...
		MMapReverseGeocoderDelegate ReverseGeocoderDelegate { get; set; }
		...
		NSObject WeakReverseGeocoderDelegate { get; set; }
